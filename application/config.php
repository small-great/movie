...
return [
    ...
    // 视图输出字符串内容替换
    //'view_replace_str'       => [
    //	'__UPLOADE__IMG__' => '/public/uploads/imgpublic/',
    //],
    // 默认跳转页面对应的模板文件
    ...
    //发送邮件配置
    'mailarr'               => [
        'host'      => 'smtp.163.com',//配置邮件的服务器地址
        'username'  => '',//发送邮件方的邮箱地址
        'password'  => '',//发送邮件方的授权密码
    ],

    //发送手机号验证码类配置 云之讯开发者控制台
    'ucpaas'        => [
        'accountsid'      => '',//填写在云之讯开发者控制台首页上的Account Sid
        'token'  => '',//填写在云之讯开发者控制台首页上的Auth Token
        'appid'  => '',//应用的ID，可在云之讯开发者控制台内的短信产品下查看
        'templateid'  => '', //模板id   //可在云之讯后台短信产品→选择接入的应用→短信模板-模板ID，查看该模板ID
        'param'  => rand(100000,999999), // 验证码  发送到手机号的验证码规则
        'second'  => 180, //发送到手机号的验证码的过期时间 单位秒s
    ],
