<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"C:\wamp64\www\o2o25project\tp5\public/../application/admin\view\Admin\password.html";i:1530413189;s:77:"C:\wamp64\www\o2o25project\tp5\application\admin\view\AdminPublic\public.html";i:1530412825;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>修改管理员密码</title>
...
<div id="content-header">
  <div id="breadcrumb">
   ...
   <a href="/admin/list" class="current">管理员管理</a><a href="JavaScript:;" class="current">修改管理员名称和密码</a><a href="javascript:history.go(-1)" class="current"><i class="icon-undo"></i>后退</a>
  </div>
 </div>
      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="/admin/dopassword" name="basic_validate" id="basic_validate" novalidate="novalidate">
              <div class="control-group">
                <label class="control-label">管理员名称</label>
                <div class="controls">
                  <input type="text" name="name" id="name" value="<?php echo $admins['name']; ?>">
                </div>
              </div>
              <div class="control-group">
