<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"C:\wamp64\www\o2o25project\tp5\public/../application/admin\view\Admin\rolelist.html";i:1530413350;s:77:"C:\wamp64\www\o2o25project\tp5\application\admin\view\AdminPublic\public.html";i:1530412825;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>分配角色</title>
...
<div id="content">
 ...
 <div id="content-header">
  <div id="breadcrumb">
   ...
   <a href="/role/index" class="current">角色管理</a><a href="JavaScript:;" class="current">分配角色</a><a href="javascript:history.go(-1)" class="current"><i class="icon-undo"></i>后退</a>
  </div>
 </div>
      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-info-sign"></i> </span>
            <h5>当前用户 <span style="color:blue"><?php echo $info['name']; ?></span> 的角色信息</h5>
          </div>
          <div class="widget-content nopadding">
            <form class="form-horizontal" action="/admin/saverole" method="post" name="basic_validate" id="basic_validate" novalidate="novalidate">
            ...
            <div class="control-group">
                <label class="checkbox" style="margin-left:35px;line-height:40px"><input type="checkbox" name="rid[]" id="" style="margin-top:14px" value="<?php echo $row['id']; ?>" <?php if(in_array($row['id'],$rids)): ?>checked<?php endif; ?>><?php echo $row['name']; ?></label>
            </div>
            <?php endforeach; endif; else: echo "" ;endif; ?>
              <div class="form-actions">
                <input type="hidden" value="<?php echo $info['id']; ?>" name="aid" class="btn btn-success">
                <input type="submit" value="保存角色" class="btn btn-success">
              </div>
            </form>
          </div>
        </div>
