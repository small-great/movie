<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"C:\wamp64\www\o2o25project\tp5\public/../application/admin\view\Admin\index.html";i:1530667431;s:77:"C:\wamp64\www\o2o25project\tp5\application\admin\view\AdminPublic\public.html";i:1530412825;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>深蓝后台首页</title>
...
<div id="content">
 ...
 <div id="content-header">
  <div id="breadcrumb">
   <a href="/admin/index" class="tip-bottom" data-original-title="去首页"><i class="icon-home"></i>首页</a><a href="javascript:history.go(-1)" class="current"><i class="icon-undo"></i>后退</a>
  </div>
 </div>
<!--End-breadcrumbs-->
<!--Chart-box-->
<div class="container-fluid"  style="text-align:center" >
  <h1>欢迎<span style="color:red;"><?php echo \think\Session::get('adminuser'); ?></span>来到深蓝后台首页</h1>
    <div class="row-fluid">
      <div class="widget-box">
        <div class="widget-title bg_lg"><span class="icon"><i class="icon-signal"></i></span>
          <h5>网站首页</h5>
        </div>
        <div class="widget-content" style="height:350px;background:url('/static/admins/bgimg.jpg');background-size:100% 100%;">
        </div>
      </div>
    </div>
  </div>
