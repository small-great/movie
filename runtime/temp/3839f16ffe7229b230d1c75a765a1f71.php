<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"C:\wamp64\www\o2o25project\tp5\public/../application/admin\view\Order\edit.html";i:1530418781;s:77:"C:\wamp64\www\o2o25project\tp5\application\admin\view\AdminPublic\public.html";i:1530412825;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>订单修改</title>
...
<link rel="stylesheet" href="/static/homes/css/cinemas-seat.d66e64ba.css"/>
 ...
 <div id="content-header">
  <div id="breadcrumb">
   ...
   <a href="/order/list" class="current">订单管理</a><a href="JavaScript:;" class="current">订单修改</a><a href="javascript:history.go(-1)" class="current"><i class="icon-undo"></i>后退</a>
  </div>
 </div>
    ...
    <div class="span12">
      <div class="widget-box">
        ...
        <div class="widget-content">
          ...
          <form class="form-horizontal" method="post" action="/order/update" name="basic_validate" id="basic_validate" novalidate="novalidate">

            <div class="control-group">
              <label class="control-label">电影名称</label>
              <div class="controls">
                <input type="text"  id="movie" value="<?php echo $movie['ch_name']; ?>" placeholder="输入电影的中文名称或者英文名称"><br>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                 <select name="cid" id="">
                   ...
                   <option value="<?php echo $row['id']; ?>" <?php if($row['id']==$order['cid']): ?>selected<?php endif; ?>><?php echo $row['name']; ?></option>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="relss" value="<?php echo $order['relss']; ?>" ><br>
              </div>
            </div>
           ...
           <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="seat"  value="<?php echo $order['seat']; ?>" ><br>
              </div>
            </div>

            <div class="control-group">
              <label class="control-label">购买票数</label>
              <div class="controls">
                <input type="text" name="num" value="<?php echo $order['num']; ?>" ><br>
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="price" value="<?php echo $order['price']; ?>" ><br>
              </div>
            </div>
             ...
             <div class="control-group">
              ...
              <div class="controls">
               <label style="display:inline-block">
                  <input type="radio" name="status" value="0" <?php if($order['status'] == 0): ?>checked<?php endif; ?> ><span style="position:relative;top:3px;left:3px">已支付(未取票)</span>
               </label>&nbsp;&nbsp;&nbsp;&nbsp;
               <label style="display:inline-block">
                  <input type="radio" name="status" value="1" <?php if($order['status'] == 1): ?>checked<?php endif; ?> ><span style="position:relative;top:3px;left:3px">已支付(已取票)</span>
               </label>&nbsp;&nbsp;&nbsp;&nbsp;
               <label style="display:inline-block">
                  <input type="radio" name="status" value="1" <?php if($order['status'] == 2): ?>checked<?php endif; ?> ><span style="position:relative;top:3px;left:3px">未支付</span>
               </label>&nbsp;&nbsp;&nbsp;&nbsp;
               <label style="display:inline-block">
                  <input type="radio" name="status" value="1" <?php if($order['status'] == 3): ?>checked<?php endif; ?> ><span style="position:relative;top:3px;left:3px">已退票</span>
               </label>
              </div>
            </div>
...
<script>
  $(document).ready(function(){ $("#movie").focus();});
