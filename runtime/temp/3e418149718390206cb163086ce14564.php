<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"C:\wamp64\www\o2o25project\tp5\public/../application/admin\view\User\editinfo.html";i:1529456073;s:77:"C:\wamp64\www\o2o25project\tp5\application\admin\view\AdminPublic\public.html";i:1530412825;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>修改详情</title>
      ...
      <div class="span12">
        <div class="widget-box" style="opacity:1;position:fixed;box-shadow: darkgrey 10px 10px 20px 5px;">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="/user/updateinfo" enctype="multipart/form-data">
            <div class="control-group span12">
	            ...
	            <div class="span4">
	                <label class="control-label"><i class="icon-tags" style="margin-right:7px;"></i>邮 箱 :</label>
	                <div class="controls">
	        ...
	        <div class="control-group span12" style="margin:0;" >
            	<div class="span4">
	                ...
	                <div class="controls">
	                  <input type="text" name="birthday"  onClick="WdatePicker({skin:'default',Date:'%y-%M-%d'})" value="<?php echo $data['birthday']; ?>" >
	                </div>
	            </div>
	            <div class="span4">
	        ...
	        <div class="control-group span12" style="margin:0;" >
	            ...
	            <div class="span4">
	                ...
	                <div class="controls " class="span3">
	                  <input type="text" name="phone" value="<?php echo $data['phone']; ?>" maxlength="11">
	                </div>
	             </div>
	        </div>
	        <div class="control-group span12" style="margin:0;" >
	            <div class="span4">
	                ...
	                <div class="controls " class="span3">
	                  <input type="text" name="desc" placeholder="做个自我介绍吧~" value="<?php echo $data['desc']; ?>">
	                </div>
	             </div>
	            <div class="span4">
	                <label class="control-label"><i class="icon-group" style="margin-right:10px;"></i>性 别 :</label>
	                <div class="controls" style="margin-top:5px;">
	                  <label style="display:inline-block;"><input type="radio" name="sex" value="1" <?php if($data['sex']==1): ?>checked<?php endif; ?>>男</label>
	                  <label style="display:inline-block;"><input type="radio" name="sex" value="0" <?php if($data['sex']==0): ?>checked<?php endif; ?> style="margin-left:15px;">女</label>
	                </div>
	            </div>
	        </div>
	        <div class="control-group span12" style="margin:0;" >
	        	<div class="span4">
					<label class="control-label"><i class="icon-picture" style="margin-right:8px;"></i>头 像 :</label>
		            <div class="controls " class="span3">
		                <span><img src="<?php echo $data['picurl']; ?>" width="70px" alt=""></span>
		            </div>
		        </div>
	            <div class="span4">
            ...
            <div class="form-actions">
            	...
            	<input type="hidden" name="pic" value="<?php echo $data['picurl']; ?>">
