<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"C:\wamp64\www\o2o25project\tp5\public/../application/admin\view\MovieImage\list.html";i:1530415453;s:77:"C:\wamp64\www\o2o25project\tp5\application\admin\view\AdminPublic\public.html";i:1530412825;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>图片列表</title>
   ...
   <div class="span12">
    <div class="widget-box">
     ...
     <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
      ...
      <tr class="gradeA odd text-center">
        <td width="200" class="va-t" style="text-align:left">
          ...
          <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$row): ?>
            <ul class="ul">
              <li>
                <span class="btn btn-lg btn-success" title="<?php echo $row['en_name']; ?>"><i class="glyphicon icon-plus-sign glyphicon-cog"></i><?php echo $row['ch_name']; ?></span>
                  <ul class="ull">
                    <li>
                     <span director="<?php echo $row['id']; ?>" name="director"  class="btn btn-sm btn-warning"><i class="icon-time"></i><a href="javascript:;" style="text-decoration: none;">导演</a></span>
                    </li>
                    <li>
                     <span actor="<?php echo $row['id']; ?>" name="actor" class="btn btn-sm btn-warning"><i class="icon-time"></i><a href="#" style="text-decoration: none;">演员</a></span>
                    </li>
                 </ul>
              </li>
            </ul>
      ...
      <tr><td colspan="4"><div id="pages" ><?php echo $data->appends($request)->render(); ?></div></td></tr>
      </table>
      </div>
     <div class="dataTables_filter" id="DataTables_Table_0_filter">
      <form action="/movieimage/list" method="get">
        <label><input type="text" name="keywords" placeholder="电影中文名" value="<?php echo $k; ?>"><input type="submit" class="btn btn-info" value="搜索"></label>
      </form>
    </div>
    </div>
   </div>
