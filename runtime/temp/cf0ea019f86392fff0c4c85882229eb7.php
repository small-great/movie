<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"C:\wamp64\www\o2o25project\tp5\public/../application/index\view\Register\register.html";i:1529563612;}*/ ?>
﻿<!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
			...
			<form action="/register/mail" method="post" id="mff">
				<div class="reg-form" id="js-form-mail" style="display: none;">
					...
					<div class="cell vcode">
						...
						<img id="js-mail_vcode_img" src="<?php echo captcha_src(); ?>" onclick='this.src="<?php echo captcha_src(); ?>?rand="+Math.random()' alt="" />
						<span>
						<a id="js-mail_vcode_a" href="javascript:;" onclick='a.src="<?php echo captcha_src(); ?>?rand="+Math.random()'>
						换一张</a></span>
						<br><br>
						<i class="icon7"></i>
					</div>
