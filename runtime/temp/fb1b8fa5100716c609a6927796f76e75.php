<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"C:\wamp64\www\o2o25project\tp5\public/../application/admin\view\Lists\edit.html";i:1530413579;s:77:"C:\wamp64\www\o2o25project\tp5\application\admin\view\AdminPublic\public.html";i:1530412825;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>修改权限</title>
...
<div id="content-header">
  <div id="breadcrumb">
   ...
   <a href="/adminlists/index" class="current">权限管理</a><a href="JavaScript:;" class="current">修改权限</a><a href="javascript:history.go(-1)" class="current"><i class="icon-undo"></i>后退</a>
  </div>
</div>
    ...
    <div class="span12">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form class="form-horizontal" action="/adminlists/update" method="post"  name="basic_validate" id="basic_validate" novalidate="novalidate">
            <div class="control-group">
              <label class="control-label">权限名</label>
              <div class="controls">
                <input type="text" name="name" id="name" value="<?php echo $node['name']; ?>">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">控制器</label>
              <div class="controls">
                <input type="text" name="mname" id="mname" value="<?php echo $node['mname']; ?>" placeholder="请输入英文组合">
              </div>
            </div>
            <div class="control-group">
              <label class="control-label" >方法</label>
              <div class="controls">
                <input type="text" name="aname" id="aname" value="<?php echo $node['aname']; ?>" placeholder="以get或者post开头的的英文">&nbsp;<span></span>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">状态</label>&nbsp;
              <label class="radio" style="margin-left:35px;line-height:40px"><input type="radio" name="status" <?php if($node['status']==0): ?>checked<?php endif; ?> id="status" style="margin-top:14px" value="0">启用</label>
              <label class="radio" style="margin-left:35px;line-height:40px"><input type="radio" name="status" <?php if($node['status']==1): ?>checked<?php endif; ?> id="status" style="margin-top:14px" value="1">禁用</label>
            </div>
