<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"C:\wamp64\www\o2o25project\tp5\public/../application/admin\view\Ads\list.html";i:1530414078;s:77:"C:\wamp64\www\o2o25project\tp5\application\admin\view\AdminPublic\public.html";i:1530412825;s:66:"C:\wamp64\www\o2o25project\tp5\application\admin\view\Ads\add.html";i:1529456073;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>广告列表</title>
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> 控制台</a>
  <ul>
    ...
    <li class="submenu open"> <a href="#"><i class="icon icon-random"></i><span>广告管理</span> </a>
...
<div id="content">
 ...
 <div id="content-header">
  <div id="breadcrumb">
   ...
   <a href="/ads/list" class="current">广告管理</a><a href="/ads/list" class="current">广告列表</a><a href="javascript:history.go(-1)" class="current"><i class="icon-undo"></i>后退</a>
  </div>
 </div>
      ...
      <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
       <div class="">
        <div id="DataTables_Table_0_length" class="dataTables_length">
          <a href="JavaScript:;" class="btn btn-primary" data-toggle="modal" data-target="#myModal">添加广告</a>
        </div>
         <!-- 模态框（Modal） -->
		...
		<div class="modal-content " >
			...
			<div class="modal-body">
					<div class="widget-box">
						...
						<div class="widget-content nopadding">
							<form class="form-horizontal" action="/ads/insert" method="post"  name="basic_validate" id="basic_validate" novalidate="novalidate" enctype="multipart/form-data">
       ...
       <table class="table table-bordered data-table dataTable" id="DataTables_Table_0">
        ...
        <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$row): ?>
         ...
         <td class=""><input type="checkbox" value="<?php echo $row['id']; ?>"></input></td>
          ...
          <!-- <td class=""><img src="<?php echo $row['picurl']; ?>" width="50px"></td> -->
          <td ><ul class="thumbnails">
      <li class="span12"> <img src="<?php echo $row['picurl']; ?>" width="30"><div class="actions"><a class="lightbox_trigger" href="<?php echo $row['opic']; ?>"><i class="icon-search"></i></a></div></li>
      </ul></td>
          <td class=""><span class="btn btn-mini btn-info"><?php echo $row['name']; ?></span></td>
          <td class=""><?php echo $row['url']; ?></td>
          <td class=""><?php echo $row['desc']; ?></td>
          <td class="td-manage">
            <a href="/ads/edit/id/<?php echo $row['id']; ?>" class="btn btn-mini btn-primary" title="修改"><i class="icon-pencil"></i></a>
            <a href="JavaScript:;" onclick="del('<?php echo $row['id']; ?>')" dname="<?php echo $row['id']; ?>"  class="btn btn-mini btn-danger" title="删除"><i class="icon-trash"></i></a>
          </td>
         </tr>
        <?php endforeach; endif; else: echo "" ;endif; ?>
         <tr>
            ...
            <div id="DataTables_Table_0_length" class="dataTables_length" style="width:100px;float:left;margin-left:0;">
              <a href="JavaScript:;" class="btn btn-danger mdelete" >批量删除</a>
            </div>
       ...
       <div class="fg-toolbar ui-toolbar ui-widget-header ui-corner-bl ui-corner-br ui-helper-clearfix">
          ...
          <div class="dataTables_filter" id="DataTables_Table_0_filter">
            <form action="/ads/list" method="get">
              <label><input type="text" name="keywords" placeholder="广告名称" value="<?php echo $k; ?>"><input type="submit" class="btn btn-info" value="搜索"></label>
            </form>
          </div>
        </div>
       </div>
...
function del(id){
    ...
    $.post("/ads/delete",{id:id},function(data){
        if(data){
          if(data['code']==0){
...
$('.mdelete').click(function(){
    ...
    //Ajax删除
     layer.confirm('确定要彻底删除吗？',function(index){
        $.get("/ads/mdelete",{arr:arr},function(data){
        if(data){
            if(data['code']==0){
