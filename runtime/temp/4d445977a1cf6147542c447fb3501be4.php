<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"C:\wamp64\www\o2o25project\tp5\public/../application/admin\view\User\edit.html";i:1530413911;s:77:"C:\wamp64\www\o2o25project\tp5\application\admin\view\AdminPublic\public.html";i:1530412825;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>修改用户详情</title>
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="/user/update" name="basic_validate" id="basic_validate" novalidate="novalidate">
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="name" id="name" value="<?php echo $data['username']; ?>">
                ...
                <div class="control-group">
                  <label class="control-label" style="padding-top:10px;">会员状态</label>
                    <label class="radio " style="margin-left:35px;line-height:40px"><input type="radio" name="status" id="ischange1" style="margin-top:14px" value="0" <?php if($data['status']==0): ?>checked<?php endif; ?>>普通用户</label>
                    <label class="radio " style="margin-left:35px;line-height:40px"><input type="radio" name="status" id="ischange2" style="margin-top:14px" value="1" <?php if($data['status']==1): ?>checked<?php endif; ?>>VIP用户</label>
                </div>
