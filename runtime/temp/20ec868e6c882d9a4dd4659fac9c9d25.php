<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"C:\wamp64\www\o2o25project\tp5\public/../application/admin\view\Movie\movie_edit.html";i:1530413023;s:77:"C:\wamp64\www\o2o25project\tp5\application\admin\view\AdminPublic\public.html";i:1530412825;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<title></title>
...
<style>.table td{text-align:center;}.iradio-blue{line-height:50px}#label label{display:inline-block;margin-right:8px;margin-top:5px;}#label label input{margin-top:0;}</style>
  <div id="content-header">
    <div id="breadcrumb">
     ...
     <a href="/movie/list" class="current">影片管理</a><a href="/movie/edit/id/<?php echo $info['id']; ?>" class="current">修改影片</a><a href="javascript:history.go(-1)" class="current"><i class="icon-undo"></i>后退</a>
    </div>
   </div>
        ...
        <div class="span12">
          <div class="widget-box">
            ...
            <div class="widget-content nopadding">
              <form class="form-horizontal" action="/Movie/update" method="post" name="basic_validate" id="basic_validate" novalidate="novalidate" enctype="multipart/form-data">
              	<input type="hidden" name="id" value="<?php echo $info['id']; ?>">
                <div class="control-group">
                  <label class="control-label">影片中文名称</label>
                  <div class="controls">
                    <input type="text" name="ch_name" id="ch_name" value="<?php echo $info['ch_name']; ?>">
                  </div>
                </div>
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" name="en_name" id="en_name" value="<?php echo $info['en_name']; ?>">
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">类型</label>
                  <div class="controls" id="label">
                  	<span><?php echo $info['m_type']; ?></span><br/>
                  	<input type="hidden" name="m_type1" value="<?php echo $info['m_type']; ?>">
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" name="country_area" id="country_area" value="<?php echo $info['country_area']; ?>">
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">电影总时长(分钟)</label>
                  <div class="controls">
                    <input type="text" name="m_time" id="m_time" value="<?php echo $info['m_time']; ?>">
                  </div>
                </div>
                <div class="control-group">
                  ...
                  <div class="controls">
                    <select name="m_version" id="m_version">
                      <option value="0" <?php if($info['m_version']==0): ?>selected<?php endif; ?>>2D</option>
                      <option value="1" <?php if($info['m_version']==1): ?>selected<?php endif; ?> >3D</option>
                      <option value="2" <?php if($info['m_version']==2): ?>selected<?php endif; ?>>2D/3D</option>
                    </select>
                  </div>
                </div>
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" name="m_director" id="m_director" value="<?php echo $info['m_director']; ?>">
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">主演</label>
                  <div class="controls">
                    <input type="text" name="m_actor" id="m_actor" value="<?php echo $info['m_actor']; ?>">
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">单价(元)起</label>
                  <div class="controls">
                    <input type="text" name="m_price" id="m_price" value="<?php echo $info['m_price']; ?>">
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">剩余量(张)</label>
                  <div class="controls">
                    <input type="text" name="surplus" id="surplus" value="<?php echo $info['surplus']; ?>">
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">上映时间</label>
                  <div class="controls">
                    <input type="text" name="m_addtime" id="m_addtime" onClick="WdatePicker({skin:'default',Date:'%y-%M-%d',maxDate:'2099-12-30'})" class="Wdate" autocomplete="off" value="<?php echo $info['m_addtime']; ?>">
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">语言</label>
                  <div class="controls">
                    <input type="text" name="laguage" id="laguage" value="<?php echo $info['laguage']; ?>">
                  </div>
                </div>
                <div class="control-group">
	              <label class="control-label">图片</label>
	              <div class="controls">
	                <input type="file" size="19" style="opacity: 1;" id="picurl" name="picurl" value="">
	                <img src="<?php echo $info['picurl']; ?>" width="30">
	              </div>
	            </div>
               <div class="control-group">
                  <label class="control-label">状态/预告/上映</label>&nbsp;
                  <label class="radio" style="margin-left:35px;line-height:40px"><input type="radio" name="status" id="status" style="margin-top:14px" value="0" <?php if($info['status']==0): ?>checked<?php endif; ?>>预告</label>
                 <label class="radio" style="margin-left:35px;line-height:40px"><input type="radio" name="status" id="status" style="margin-top:14px" value="1" <?php if($info['status']==1): ?>checked<?php endif; ?>>上映</label>
               </div>
				<div class="control-group">
	              <label class="control-label">剧情简介</label>
	              <div class="controls">
	                <textarea class="span6" name="content" maxlength="300"><?php echo $info['content']; ?></textarea>
	              </div>
	            </div>
