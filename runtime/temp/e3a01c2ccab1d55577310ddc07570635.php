<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:91:"C:\wamp64\www\o2o25project\tp5\public/../application/admin\view\Carousel\carousel_list.html";i:1530619932;s:77:"C:\wamp64\www\o2o25project\tp5\application\admin\view\AdminPublic\public.html";i:1530412825;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>轮播图列表</title>
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> 控制台</a>
  <ul>
    ...
    <li class="submenu open"> <a href="#"><i class="icon  icon-picture"></i><span>轮播图管理</span> </a>
...
<style>
 ...
 <div id="content-header">
  <div id="breadcrumb">
   ...
   <a href="/carousel/list" class="current">轮播图管理</a><a href="/carousel/list" class="current">轮播图列表</a><a href="javascript:history.go(-1)" class="current"><i class="icon-undo"></i>后退</a>
  </div>
 </div>
      ...
      <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
       <div class="">
        <div id="DataTables_Table_0_length" class="dataTables_length">
          <a href="/carousel/add" class="btn btn-primary">添加轮播图</a>
        </div>
       </div>
       <table class="table table-bordered data-table dataTable" id="DataTables_Table_0">
		...
		<th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Rendering engine: activate to sort column descending" style="width: 81px;">
          ...
          <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 100px;">
           <div class="DataTables_sort_wrapper">
           轮播图片
            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
           </div></th>
           <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 150px;">
           <div class="DataTables_sort_wrapper">
           链接地址
            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
           </div></th>
          <th class="ui-state-default" role="columnheader" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 10px;">
           <div class="DataTables_sort_wrapper">
           上下架
            <span class="DataTables_sort_icon css_right ui-icon ui-icon-carat-2-n-s"></span>
           </div></th>
        ...
        <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$row): ?>
         <tr class="gradeA odd text-center" >
          ...
          <td class=""><input type="text" name="sort" cid="<?php echo $row['id']; ?>" value="<?php echo $row['sort']; ?>" style="width:15px;padding-left:11px"></td>
          <td class=""><?php echo $row['title']; ?></td>
          <td ><ul class="thumbnails">
			<li class="span12"> <img src="<?php echo $row['img_url']; ?>" width="30" height="30"><div class="actions"><a class="lightbox_trigger" href="<?php echo $row['img_url']; ?>"><i class="icon-search"></i></a></div></li>
			</ul></td>
			<td class=""><a href="<?php echo $row['img_link']; ?>"><?php echo substr($row['img_link'],'0',30); ?>...</a></td>
          <td class="td-status"><?php if($row['status']==0): ?><span class="btn btn-mini btn-warning">已上架</span><?php else: ?><span class="btn btn-mini btn-inverse">已下架</span><?php endif; ?></td>

          <td class="td-manage">
          	<?php if($row['status']==1): ?>
            <a href="/carousel/change/id/<?php echo $row['id']; ?>/status/0" onClick="return confirm('你确定上架吗？')" class="btn btn-mini btn-warning" title="上架">上架</a>
            <?php else: ?>
            <a href="/carousel/change/id/<?php echo $row['id']; ?>/status/1" onClick="return confirm('你确定下架吗？')" class="btn btn-mini btn-inverse" title="下架">下架</a>
            <?php endif; ?>
            <a href="/carousel/edit/id/<?php echo $row['id']; ?>" class="btn btn-mini btn-info" title="编辑">编辑</a>
          ...
          <div class="dataTables_filter" id="DataTables_Table_0_filter">
            <form action="">
              <label><input type="text" name="keywords" value="<?php echo $k; ?>" aria-controls="DataTables_Table_0" placeholder="轮播图名称关键字"><input type="submit" class="btn btn-info" value="搜索"></label>
            </form>
          </div>
...
function del(id){
	...
	layer.confirm('确认要删除吗？',function(index){
		//ajax交互数据 传入id
		$.get("/carousel/delete",{id:id},function(data){
			//判断传回的数据
			if(data==1){
				if(data['code']==0){
...
$(".dels").click(function(){
	...
	$.get("/carousel/dels",{arr:arr},function(data){
		if(data == 1){
			alert("数据删除成功");
...
$("input[name='sort']").blur(function(){
  sort = $(this).val();
  id = $(this).attr("cid");
  $.get("/carousel/sort",{id:id,sort:sort},function(data){
      //判断传回的数据
      if(data){
        if(data['code']==0){
          layer.msg(data['msg'],{icon:2,time:3000});
