<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:97:"C:\wamp64\www\o2o25project\tp5\public/../application/admin\view\Information\information_edit.html";i:1530414833;s:77:"C:\wamp64\www\o2o25project\tp5\application\admin\view\AdminPublic\public.html";i:1530412825;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<title>资讯添加</title>
...
<style>.table td{text-align:center;}.iradio-blue{line-height:50px}</style>
  <div id="content-header">
    <div id="breadcrumb">
     ...
     <a href="/Information/list" class="current">资讯管理</a><a href="JavaScript:;" class="current">修改资讯</a><a href="javascript:history.go(-1)" class="current"><i class="icon-undo"></i>后退</a>
    </div>
   </div>
        ...
        <div class="span12">
          <div class="widget-box">
            ...
            <div class="widget-content nopadding">
              <form class="form-horizontal" action="/information/update" method="post" name="basic_validate" id="basic_validate" novalidate="novalidate" enctype="multipart/form-data">
                <div class="control-group">
                  <label class="control-label">标题</label>
                  <div class="controls">
                    <input class="span10" placeholder="输入该条资讯的标题" type="text" name="title" id="title" value="<?php echo $info['title']; ?>">
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">相关电影</label>
                  <div class="controls">
                    <input type="text" class="span10" name="movie" id="movie" placeholder="输入电影的中文名称或者英文名称"><br><label><input type="radio" name="mid" value="<?php echo $data['id']; ?>" checked><span><?php echo $data['ch_name']; ?></span></label>
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">发布时间</label>
                  <div class="controls">
                    <input type="text" name="newstime" id="newstime" onClick="WdatePicker({skin:'default',minDate:'%y-%M-%d'})" class="Wdate" autocomplete="off" value="<?php echo date('Y-m-d',$info['newstime']); ?>">
                  </div>
                </div>
                <div class="control-group">
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
  	              ...
  	              <div class="controls">
  	                <script id="editor" type="text/plain" style="width:700px;height:500px;" name="descr"><?php echo $info['descr']; ?></script>
  	              </div>
  	            </div>
