<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"C:\wamp64\www\o2o25project\tp5\public/../application/index\view\Users\index.html";i:1530345191;}*/ ?>
﻿<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
    ...
    <div class="main" style="margin:0px">
      <div class="info-content clearfix">
        <div class="user-profile-nav">
          <h1>个人中心</h1>
          <a href="/users/morder/order" class="orders" id="one">我的订单</a>
          <a href="/users/index/<?php echo \think\Session::get('uid'); ?>.html" class="profile active" id="two">基本信息</a>
          <a href="/users/mailer/req" class="profile" id="three">我的消息(<span style="color:red" id="s1"><?php echo $count; ?></span>)</a>
        </div>

        <!-- 基本消息页 -->
        <div class="profile-container" id="info">
          <div class="profile-title">
          基本信息
          </div>
          <form  enctype="multipart/form-data" method="post" action="/users/insert" enctype="multipart/form-data">
            <div class="avatar-container">
            <div class="avatar-content">
              <img class="J-setted-avatar" src="/static/homes/bg.jpg">
            ...
            <div class="userexinfo-form-section">
              <p>昵称：</p>
              <span>
                <input type="text" name="name" id="name" class="ui-checkbox" placeholder="2-18个字，支持中英文、数字" value="">&nbsp;&nbsp;<span></span>
              </span>
            </div>
            <div class="userexinfo-form-section">
              <p>性别：</p>
              <span>
                <input type="radio" name="sex" id="userexinfo-form-gender-1" value="1" checked class="ui-radio radio-first">
            ...
            <div class="date-picker userexinfo-form-section">
              <p>生日：</p>
              <span>
                <input type="text" name="birthday" id="birth" onClick="WdatePicker({skin:'default',maxDate:'%y-%M-%d'})" class="Wdate" autocomplete="off" value="">&nbsp;&nbsp;<span></span>
              </span>
            </div>
            ...
            <div class="userexinfo-form-section">
              <p>电话：</p>
              <span>
                <input type="text" name="phone" id="phone" maxlength="11">&nbsp;&nbsp;<span></span>
              </span>
            </div>
            <div class="userexinfo-form-section">
              <p>邮箱：</p>
            ...
            <div class="userexinfo-form-section">
              <p>从事行业：</p>
              <span>
                <input type="text" name="job" id="job">&nbsp;&nbsp;<span></span>
              </span>
            </div>
            ...
            <div class="userexinfo-form-section">
              <p>个性签名：</p>
              <span>
                <textarea name="desc" id="desc" style="width:254px;" class="ui-checkbox" placeholder="20个字以内" maxlength="20"></textarea>&nbsp;&nbsp;<span></span>
              </span>
            </div>
